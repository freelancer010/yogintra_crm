  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card card-default">
        ...
        <div class="card-body">
            <?php echo form_open(PANELURL.'admin_roles/module_add', 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="<?= ('add_module') ?>" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
        </div>
