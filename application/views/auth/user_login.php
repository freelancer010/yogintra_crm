<div class="form-background">
  <div class="login-box">
    <div class="login-logo">
      <h2><a href="<?= base_url('admin'); ?>">Frenchisor</a></h2>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <?php echo form_open(base_url('admin/auth/user_login'), 'class="login-form" '); ?>
        ...
        <p class="mb-0">
          <a href="<?= base_url('admin/auth/register_frenchisor'); ?>" class="text-center"><?= trans('register_new_membership') ?></a>
        </p>
      </div>
      <!-- /.login-card-body -->
    </div>
